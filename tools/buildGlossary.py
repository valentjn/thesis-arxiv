...
codeEntry = r"""%
\glossentry{{{}}}{{\glossaryentrynumbers{{\relax """ + r"""
...
def processInput(inputCode):
  ...
  for entry in entries:
    if entry[0].startswith("zzzzzzzz"):
      curHeading = "Ü"
    elif entry[0].startswith("zzzzzz"):
      curHeading = "Ö"
    elif entry[0].startswith("zzzz"):
      curHeading = "Ë"
    elif entry[0].startswith("zz"):
      curHeading = "Ä"
    else:
